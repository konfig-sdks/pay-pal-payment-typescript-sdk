...
/**
 * @type AuthorizationsReauthorize400DetailsInner
 * @export
 */
export type AuthorizationsReauthorize400DetailsInner = MISSINGREQUIREDPARAMETER | INVALIDSTRINGLENGTH | INVALIDSTRINGMAXLENGTH | INVALIDPARAMETERSYNTAX;
